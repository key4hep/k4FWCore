...
struct ExampleFunctionalProducerEventContext final : k4FWCore::Producer<edm4hep::MCParticleCollection()> {
  // The pair in KeyValues can be changed from python and it corresponds
  // to the name of the output collection
  ExampleFunctionalProducerEventContext(const std::string& name, ISvcLocator* svcLoc)
...
DECLARE_COMPONENT(ExampleFunctionalProducerEventContext)
