...
# Tests MergeMCParticles = False of the OverlayTiming algorithm, with the same
# background as TestOverlayTimingRandomMix.py. The background particles are not
# copied into the output, so the background tracker hits have to carry the
...
iosvc.Output = "overlay_no_mcparticle_merge.root"
