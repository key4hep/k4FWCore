 ...
 *
 *  Particle gun, that, given transverse momenta and pseudorapidities, creates the desired four-momenta.
 ...
 */
class ParticleGunPtEta : public GaudiAlgorithm {
public:
  ParticleGunPtEta(const std::string& name, ISvcLocator* svcLoc);
  virtual ~ParticleGunPtEta();
...
private:
  ...
  DataHandle<edm4hep::MCParticleCollection> m_MCParticlesHandle{"MCParticles", Gaudi::DataHandle::Writer, this};
  ...
  std::uniform_real_distribution<> m_rndmflat;
