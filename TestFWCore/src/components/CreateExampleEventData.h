...
private:
  ...
  DataHandle<std::vector<fcc::FloatValueData>> m_singleFloatHandle{"SingleFloat", Gaudi::DataHandle::Writer, this};
  DataHandle<std::vector<float>> m_vectorFloatHandle{"VectorFloat", Gaudi::DataHandle::Writer, this};
  DataHandle<std::vector<int>> m_SingleIntHandle{"SingleInt", Gaudi::DataHandle::Writer, this};
};
